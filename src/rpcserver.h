...
extern json_spirit::Value passphrasedisablespan(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value passphrasedisablemode(const json_spirit::Array& params, bool fHelp);
